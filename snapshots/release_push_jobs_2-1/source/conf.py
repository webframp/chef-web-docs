...
project = u'Push Jobs 2.1 Documentation'
...
html_title = "Push Jobs 2.1 Documentation"
...
html_last_updated_fmt = 'Push Jobs 2.1'
...
htmlhelp_basename = 'Push Jobs 2.1 Documentation'
