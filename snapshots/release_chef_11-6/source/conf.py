...
project = u'chef-client 11.6 Documentation'
copyright = u'This work is licensed under a Creative Commons Attribution 3.0 Unported License.'
html_context = {'release_info': '07/23/2013 Chef Client 11.6'}
...
html_title = "chef-client 11.6 Documentation"
...
html_last_updated_fmt = 'chef-client, version 11.6'
...
htmlhelp_basename = 'chef-client 11.6 Documentation'
